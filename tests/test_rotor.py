...
class TestRotor(unittest.TestCase):
    ...
    def test__instantiate_invalid(self):
        ...
        self.assertRaises(
            ValueError,
            Rotor, ZMUG_CAMS["psi"][0], position=-2
        )

        self.assertRaises(
            ValueError,
            Rotor, ZMUG_CAMS["psi"][0], position=100
        )
...
class TestRotorSet(unittest.TestCase):
    ...
    def test__instantiate_invalid(self):
        ...
        self.assertRaises(
            ValueError,
            RotorSet, ZMUG_CAMS["chi"], positions=[1, 2, 3, 4, 5, 6]
        )

        self.assertRaises(
            ValueError,
            RotorSet, ZMUG_CAMS["chi"], positions=[100, 100, 100, 100, 100]
        )
    ...
    def test__step(self):
        ...
        self.assertEqual(
            [2, 18, 11, 3, 17],
            [rotor.position for rotor in rotors.rotors]
        )
...
class TestMotorSet(unittest.TestCase):
    ...
    def test__instantiate_invalid(self):
        ...
        self.assertRaises(
            ValueError,
            MotorSet, ZMUG_CAMS["mu"], positions=[1, 2, 3]
        )

        self.assertRaises(
            ValueError,
            MotorSet, ZMUG_CAMS["mu"], positions=[100, 100]
        )
